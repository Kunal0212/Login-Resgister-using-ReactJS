    ...
    const [error, setError] = useState({
      ...
      return (
        ...
        <Grid container justifyContent='center'>
            ...
            <Box component='form' noValidate sx={{mt:2}} id="password-reset" onSubmit={handleSubmit}>
            ...
            <Button type="submit" variant="contained" sx={{mt:3, mb:2,px:5}}>Password Reset Successfully!!</Button>
            </Box>
